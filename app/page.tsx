      ...
      <section style={{ padding: "80px 24px", borderTop: "1px solid #111" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div className="grid-thanks" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: 1 }}>
            {[
              { name: "Павлу Мусс", title: "Генеральный директор «Принцип НОВО»", text: "За многолетнюю стратегическую поддержку проектов арт-группы «Осознанность» и личное участие в развитии нашей экосистемы." },
              { name: "Ксении Макарчук", title: "Президент Арт-клуба «Сколково»", text: "За всестороннюю помощь, мощный информационный ресурс и участие в проектах арт-группы «Осознанность»." },
              { name: "Елене Волковой", title: "Руководитель издательства «Русский мир медиа»", text: "За безупречную организацию выставочных циклов в «Ренова Лаб» и ГМИК им. К.\u00a0Э.\u00a0Циолковского." },
              { name: "Наталье Абакумовой", title: "Директор ГМИК им. К.\u00a0Э.\u00a0Циолковского", text: "За проведение выставки и высокую экспертную оценку, результатом которой стала передача части работ в фонды музея и Государственный каталог РФ." },
              { name: "Денису Щербакову", title: "Основатель «Фестиваль-Строй»", text: "За профессиональную застройку экспозиций, предоставление выставочной инфраструктуры и активное партнёрство с 2022 года." },
              { name: "Андрею Беляеву", title: "Генеральный директор «Айфлекс»", text: "За надёжное партнёрство, проверенное годами, и неизменную поддержку наших инициатив." },
            ].map(p => (
